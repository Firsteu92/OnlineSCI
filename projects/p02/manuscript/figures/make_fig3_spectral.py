...
dec = np.load(os.path.join(BASE, "data/duacs/spectral_decomposition_v2.npz"), allow_pickle=True)
...
fig.savefig(os.path.join(OUT, "fig3_spectral.pdf"), bbox_inches="tight")
fig.savefig(os.path.join(OUT, "fig3_spectral.png"), dpi=300, bbox_inches="tight")
plt.close()
print("Fig.5 saved")
